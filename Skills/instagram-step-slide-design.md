...
Reference step slides from [Ejemplos/](../Ejemplos/):
...
3. **AI-generated mockup via Nano Banana** — for complex UIs that don't exist or are hard to screenshot. Use sparingly because Nano Banana cannot reliably render exact text/labels inside UIs.
...
The carousel doesn't end on the last step — it ends on a **closing slide** whose only job is to drive engagement: a follow, a save, a comment, or a DM. Reference: **`Ejemplos/Ej_5.png`**.
